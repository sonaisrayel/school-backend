...
for (let i = 0; i < profession.length; i++) {
    ...
    if(study_year[i] && profession[i] && pay[i] && faculty[i] ){
        array.push({       
...
fs.writeFileSync("profession.json",JSON.stringify(array))
